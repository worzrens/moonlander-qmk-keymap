...
#define AUDIO_MUTE KC_AUDIO_MUTE
#define AUDIO_VOL_DOWN KC_AUDIO_VOL_DOWN
#define AUDIO_VOL_UP KC_AUDIO_VOL_UP
...
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
                                                                                                                      // Thumb L         // Thumb R
    KC_LCTRL,      LALT(KC_LSHIFT), KC_PSCREEN,     KC_LEFT,        KC_RIGHT,                                       TD(DANCE_3),    MT(MOD_LCTL, KC_ENTER),                         KC_DOWN,        KC_UP,          KC_LBRACKET,    KC_RBRACKET,    MT(MOD_LCTL, KC_ENTER),
// |---------------|---------------|---------------|---------------|--------------/                                                                                                 \--------------|---------------|---------------|---------------|---------------|
...
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
    __,            KC_EXLM,         KC_AT,          KC_LCBR,        KC_RCBR,        KC_PIPE,        TO(L_MAIN),                                     __,             KC_UP,          KC_7,           KC_8,           KC_9,           KC_ASTR,        KC_F12,
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
...
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
    MU_TOG,         __,             __,             KC_MS_UP,       __,             __,             __,                                             TO(L_MAIN),     __,             __,             __,             __,             __,             __,
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
...
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
                                                                                                                     // Thumb L         // Thumb R
    __,             __,             __,             KC_MS_BTN1,     KC_MS_BTN2,                                         __,         KC_MEDIA_PLAY_PAUSE,                            ZOOM_OUT,       ZOOM_IN,        MEDIA_PREV,     MEDIA_NEXT,     __,
// |---------------|---------------|---------------|---------------|--------------/                                                                                                 \--------------|---------------|---------------|---------------|---------------|
                                                                            // Piano L1          // Piano L2         // Piano L3             // Piano R3         // Piano R2     // Piano R1
                                                                                __,                 __,                 __,                   AUDIO_MUTE,       AUDIO_VOL_DOWN, AUDIO_VOL_UP
  ),
...
// |---------------|---------------|---------------|---------------|---------------|---------------|---------------|                               |---------------|---------------|---------------|---------------|---------------|---------------|---------------|
                                                                                                                     // Thumb L         // Thumb R
    __,             __,             __,             __,             __,                                                 KC_ENTER,           __,                                                     __,         __,         __,         __,         __,
// |---------------|---------------|---------------|---------------|--------------/                                                                                                 \--------------|---------------|---------------|---------------|---------------|
                                                                             // Piano L1          // Piano L2         // Piano L3             // Piano R3         // Piano R2     // Piano R1
                                                                                __,                    __,              __,                         __,              __,              __
  ),
